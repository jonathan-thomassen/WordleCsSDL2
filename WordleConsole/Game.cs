...
namespace WordleConsole
{
    internal class Game
    {
        ...
        public void Initialize()
        {
            ...
            _grid = [[new Square(), new Square(), new Square(), new Square(), new Square()],
        ...
        public void NewWord()
        {
            //int wordNumber = Random((len(words.WORDS) - 1));
            _word = "quite"; //_wordList[wordNumber];
        }
